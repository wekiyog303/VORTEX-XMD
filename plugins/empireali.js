...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "255760774888@s.whatsapp.net", // Replace with staff contact numbers
                "255760774888@s.whatsapp.net", // Example: Add staff members here
                "255760774888@s.whatsapp.net", // Example: Add staff members here
                "255760774888@s.whatsapp.net", // Example: Add staff members here
                "255760774888@s.whatsapp.net", // Example: Add staff members here
                "255760774888@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "𓆩VORTEX-XMD𓆪";
            const imageUrl = "https://github.com/Mrhanstz/VORTEX-XMD/raw/refs/heads/main/HansTz/HansTz.jpg"; // Replace with the actual image URL
