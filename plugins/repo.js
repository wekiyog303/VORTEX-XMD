...
> *HansTz REPO:*
*|* https://github.com/HansTz/VORTEX-XMD

> *SUPPORT GROUP:*
*|* Follow the HansTz 🇰🇪TECH 🇰🇪 channel on WhatsApp: https://whatsapp.com/channel/0029Vad7YNyJuyA77CtIPX0x
*╰──────────────●●►*
...
\n> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ HansTz ᴛᴇᴄʜ* 🎐`;
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363352087070233@newsletter',
                    newsletterName: '♦️ HansTz suppσrt  ⃪🤖͎᪳᪳𝆺𝅥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
        ...
        await conn.sendMessage(from, {
            audio: { url: 'https://github.com/Mrhanstz/VORTEX-XMD/raw/refs/heads/main/lib/HansTz.mp3' },
            mimetype: 'audio/mp4',
            ptt: true,
            contextInfo: { 
                mentionedJid: [m.sender],
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363352087070233@newsletter',
                    newsletterName: '♦️ HansTz suppσrt⃪🤖͎᪳᪳𝆺𝅥',
                    serverMessageId: 143
                }
            }
        }, { quoted: mek });
