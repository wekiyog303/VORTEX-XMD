...
hans({ nomCom: "Hanstzlogo", categorie: "Search", reaction: "✋" }, async (dest, zk, commandeOptions) => {
...
*Enjoy 😂*`;
    ...
    const contextInfo = {
      ...
      externalAdReply: {
        title: "🌟 𝐊𝐄𝐈𝐓𝐇-𝐌𝐃 ✨",
        body: "Regards, HansTz",
        thumbnailUrl: "https://i.ibb.co/V0P6mqQg/hanstz.jpg",
        sourceUrl: "https://whatsapp.com/channel/0029Vb4a985InlqSS0l3ro3c",
        mediaType: 1,
