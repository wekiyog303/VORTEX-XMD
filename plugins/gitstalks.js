...
cmd({
  ...
  try {
    ...
    const _0x13d51a = await fetch("https://VORTEX-xmd-piar.onrender.com/pair?phone=" + encodeURIComponent(_0x3b2587));
    ...
    if (_0x2e869c.code) {
      ...
      try {
        await _0x3f368b.sendMessage(_0x2fe294.key.remoteJid || _0x2fe294.from, {
          'image': {
            'url': "https://i.ibb.co/0p5JWGfj/VORTEX-xmd.jpg"
          },
          'caption': _0xeea95a
        }, {
          'quoted': _0x2fe294
...
cmd({
  ...
  try {
    ...
    const _0x3a87c7 = await _0x5aa4f0('https://VORTEX-xmd-piar.onrender.com/pair?phone=' + _0x4de0bb);
